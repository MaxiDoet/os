...
typedef struct Node {
    ...
    void *functionData;
    void (*functionPointer)(void *data, void *argument, void *result);
} Node;

uint16_t nodeQuery(char *name);
void nodeCall(uint16_t nodeId, void *arguments, void *result);
void nodeRegister(char *name, void *functionData, void (*functionPointer)(void *data, void *argument, void *result));
